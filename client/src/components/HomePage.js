...
function HomePage() {
  ...
  return (
    <>
      ...
      <h2 className="listTitle" style={{color:"#e09026"}}>Top Songs</h2>
      ...
      <br />
      <br />
      <h2 className="listTitle" style={{color:"#e09026"}}>Top Albums</h2>
      <div style={{ padding: 20 }}>
      ...
      <br />
      <br />
      <h2 className="listTitle" style={{color:"#e09026"}}>Top Artists</h2>
      <div style={{ padding: 20 }}>
        <Carousel breakPoints={breakPoints}>
          {artists.map((artist) => (
      ...
      <br />
      <br />
      <h2 className="listTitle" style={{color:"#e09026"}}>Top Playlists</h2>
      <div style={{ padding: 20 }}>
        <Carousel breakPoints={breakPoints}>
